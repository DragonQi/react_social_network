...
export const setTotalUsersCountCreator = (totalUsersCount) => ({type: SET_TOTAL_USERS_COUNT, countNumber: totalUsersCount})
export const setToggleIsFetchingCreator = (isFetching) => ({type: TOGGLE_IS_FETCHING, isFetching});